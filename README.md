...
Тема: Управление потоками ввода/вывода, работа с интерпретаторами, алиасами, переменными окружения и конвейерами команд

Цель работы: Изучить и освоить на практике механизмы перенаправления стандартных потоков ввода/вывода, работу с несколькими командными интерпретаторами (bash, sh, zsh, fish), создание временных и постоянных алиасов, управление временными и постоянными переменными окружения, а также способы объединения команд в одной строке и передачи вывода одной команды на вход другой (конвейеры).

Выполнил: студент группы СА-1-25 Вергуленко Владислав
